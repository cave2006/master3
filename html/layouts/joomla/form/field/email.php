...
echo $name; ?>"<?php
echo !empty($class) ? ' class="uk-input validate-email ' . $class . '"' : ' class="uk-input validate-email"'; ?> id="<?php
echo $id; ?>" value="<?php
echo htmlspecialchars(PunycodeHelper::emailToUTF8($value), ENT_COMPAT, 'UTF-8'); ?>"
