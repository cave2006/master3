...
<div class="profile<?php echo $this->pageclass_sfx; ?>">
	...
	<ul data-uk-tab="connect:#com-users-profile-content">
		<li><a href="#"><?php echo JText::_('COM_USERS_PROFILE_CORE_LEGEND'); ?></a></li>
		<li><a href="#"><?php echo JText::_('COM_USERS_SETTINGS_FIELDSET_LABEL'); ?></a></li>
		<?php if ($fieldsets) { ?>
		<li><a href="#"><?php echo JText::_('JOPTIONS'); ?></a></li>
		<?php } ?>
	</ul>
