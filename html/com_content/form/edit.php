...
<div class="uk-article edit item-page<?php echo $this->pageclass_sfx; ?>">
	...
	<form action="<?php echo Route::_('index.php?option=com_content&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
		...
		<div class="uk-margin-top">
			<button type="button" class="uk-button uk-button-primary" onclick="Joomla.submitbutton('article.save')"><span data-uk-icon="icon:ok"></span><?php echo Text::_('JSAVE') ?></button>
			<button type="button" class="uk-button uk-button-default" onclick="Joomla.submitbutton('article.cancel')"><span data-uk-icon="icon:cancel"></span><?php echo Text::_('JCANCEL') ?></button>
